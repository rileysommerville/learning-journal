...
I copied my content from my Joomla site, which included several pages, but I forgot to change the category and commenting settings at the time I created these pages, so I found and used the bulk page editor on the WordPress dashboard to make all of my changes simultaneously.
