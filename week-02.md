...
## Learning Activities
After watching the lecture, I watched the demo on using Vagrant and ScotchBox to set up a local Joomla environment. While watching the demo, I read the documentation for Vagrant and Joomla to better understand how they worked.
